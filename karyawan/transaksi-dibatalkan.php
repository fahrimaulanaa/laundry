...
<div class="flex">
        <div class="w-1/5 bg-gray-800 h-screen">
            ...
            <nav class="text-white text-base font-semibold pt-3 ">
                ...
                <a href="transaksi-dibatalkan.php" class=" font-bold flex items-center text-white opacity-100 hover:opacity-100 py-4 pl-6 nav-item">
        ...
        <div class="flex justify-between items-center">
            <h1 class="text-3xl font-semibold items-center justify-center" align="center">Transaksi Dibatalkan</h1>
            <br>
            <br>
            <br>
        </div>
